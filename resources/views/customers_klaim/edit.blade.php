    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="fileUploadForm" action="{{ route('klaim.update', $order->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf @method('put')
                        <div class="row">
                            <!-- nomor_nota -->
                            ...
                            <div class="col-12 col-md-8 mb-2">
                                ...
                                <div class=" mt-3"  >
                                    <div class="input-group input-group-sm mb-3" >
                                        <input style="height:100% !important" type="file" class="form-control" name="klaim_video"   >
                                    </div>
                                </div>
