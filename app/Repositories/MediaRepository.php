...
class MediaRepository extends Repository
{
    ...
    public function storeByGaransi(UploadedFile $file, string $path, string $description = null, string $type = null): Media
    {
        ...
        $foto_bukti = 'SMP_'.$kode.'_'.$jam.'X'.$menit.'-'.$x.'.'.$extension;
