...
class MediaRepository extends Repository
{
    ...
    public function storeByGaransi(UploadedFile $file, string $path, string $description = null, string $type = null, $urutan): Media
    {
        ...
        $path = Storage::put('/'. trim($path, '/'), $file, 'public');
        if(!$type){
            $type = in_array($extension, ['jpg', 'png', 'jpeg', 'gif', 'mp4', 'avi']) ? 'image' : $extension;
        }
    ...
    public function updateByKlaim(UploadedFile $file, string $path, string $description = null, string $type = null, $urutan): Media
    {
